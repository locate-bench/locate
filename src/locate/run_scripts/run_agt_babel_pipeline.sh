...
#CUDA_VISIBLE_DEVICES=1 bash run_scripts/run_agt_trainer.sh babel 20 1 1 100 2 1e-5 learned 1e-5 30 100 4 4 256 4 512 0 1500 0 0 100 600
CUDA_VISIBLE_DEVICES=0 bash run_scripts/run_agt_full_pipeline.sh babel 20 1 1 100 2 1e-5 learned 1e-5 30 100 4 4 256 4 512 0 1500 0 0 100 600
