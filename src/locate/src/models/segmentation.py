...
def sigmoid_focal_loss(inputs, targets, num_boxes, alpha: float = 0.25, gamma: float = 2):
    ...
    Args:
        ...
        num_boxes: only number of positive examples
    Returns:
        Loss tensor
    """
    ...
    if torch.is_tensor(alpha):
        # print('alpha.shape: {}, targets.shape: {}'.format(alpha.shape, targets.shape))
        # alpha.shape: torch.Size([2, 100, 20]), targets.shape: torch.Size([2, 100, 20])
