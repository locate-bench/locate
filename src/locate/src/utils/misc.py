...
def nested_tensor_from_tensor_list(tensor_list: List[Tensor]):
    ...
    # print('batch_shape: ', batch_shape, len(tensor_list), max_size) # [2, 600, 100] 2 [600, 100]
    b, c, t = batch_shape
...
def accuracy(output, target, topk=(1,)):
    ...
    # print('target: ', target,) # target:  tensor([0, 0]
    # print( 'pred: ', pred, 'output.shape: ', output.shape, 'output', output)
    res = []
    for k in topk:
